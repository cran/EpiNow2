...
#include "stanExports_simulate_secondary.h"

RCPP_MODULE(stan_fit4simulate_secondary_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_simulate_secondary")
